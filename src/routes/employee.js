...
module.exports = (router) => {
  ...
  router.route("/terminated").get(controller.showAllTerminated);
  router.route("/managers").get(controller.showManagers);
  router.route("/employees/:id").post(controller.showOne);
  router.route("/employees/find/myteam/").post(controller.showMyTeam);
  ...
  router.route("/employees/").delete(controller.deleteRecord);
