...
module.exports = (router) => {
  ...
  router.route("/appusers/refresh").get(controller.refresh);
  router.route("/appusers/:id").post(controller.showOne);
  router.route("/appusers/find/email").post(controller.findByEmail);
  router.route("/appusers/find/token").post(controller.findByToken);
  ...
  router.route("/appusers/update/bulk").put(controller.updateBulkRecord);
