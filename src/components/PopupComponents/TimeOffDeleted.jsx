...
/**
 * More detailed popup component for notifying the user that their time off request was deleted
 * 
 * Props:
 ...
 *      Default: {}
 */
export default function TimeOffDeleted({request_information, close, style}) {
