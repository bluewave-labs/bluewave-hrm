...
import AvailableTimeOffTableContainer from './AvailableTimeOffTableContainer';
/**
...
export default function TimeOffMenu({style}) {
    ...
    AvailableTimeOffTableContainer.policies
    //List of time off policies
    const policies = AvailableTimeOffTableContainer.policies;
